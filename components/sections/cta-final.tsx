  ...
  return (
    ...
    >
      ...
      <p className="mx-auto mt-3 max-w-xl text-base text-slate-200">
        Remplissez le formulaire maintenant. Sous 48 heures, vous recevez un
        premier bilan clair de votre site — zones à risque, points prioritaires,
        estimation pour l&apos;audit complet. Sans engagement.
      </p>
